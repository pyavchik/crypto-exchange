...
- [Market-data cache, stale-serve contract, and the USD/USDT quote convention](pages/decisions/market-data-cache-and-stale.md) — keyed in-memory TTL cache, last-good stale fallback, verified Demo rate limits, accepted monthly-cap exposure
