---
name: Bug report
about: Report a defect with reproduction steps and request-ID evidence
title: "BUG: "
labels: bug
---
...
This issue is a mirror. The canonical copy of this bug report is filed as
`qa/bugs/BUG-NNN-SLUG.md` in the repository.
